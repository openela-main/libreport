...
Patch4:               6000-use-openela-workflow.patch
...
%changelog
* Thu Jan 25 2024 Release Engineering <releng@openela.org> - 2.15.2.openela.0.2
- Add openela workflow for mantis
- Remove RHEL and Fedora packages
